      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 animate-bounce-in">
          <div className="inline-block mb-6">
            <span className="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-bold px-6 py-3 rounded-full shadow-lg shadow-purple-500/20 uppercase tracking-wider">
              ✨ AI-Powered Generator
            </span>
          </div>
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Create Your <span className="gradient-text">Coding</span> Problem
          </h1>
          <p className="text-2xl text-gray-200 max-w-2xl mx-auto font-medium">
            Describe your problem in <span className="text-purple-400 font-bold">any language</span> and let AI generate it instantly
          </p>
        </div>
        ...
        <div className="glass-strong rounded-3xl shadow-2xl border-2 neon-border overflow-hidden animate-scale-in hover-glow">
          ...
          <div className="p-8 md:p-10">
            <label className="block text-white mb-4 font-bold text-2xl flex items-center">
              <span className="text-3xl mr-3">📝</span> Describe Your Problem
            </label>
            <textarea
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Example: 'teen numbers ka maximum nikalo' or 'find sum of two numbers'&#10;&#10;Support for English, Hindi, and Hinglish"
            ...
            <div className="flex items-start mt-4 text-gray-300 text-sm bg-gradient-to-r from-cyan-500/10 to-blue-500/10 p-4 rounded-xl border border-cyan-500/20">
              ...
              <span className="font-medium">
                <strong className="text-cyan-300">Tip:</strong> Be specific! Mention "three numbers" or "teen sankhya" 
                for better results. The AI understands context.
              </span>
            </div>
          </div>
          ...
          <div className="px-8 md:px-10 pb-8 md:pb-10">
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 hover:from-purple-500 hover:via-pink-500 hover:to-cyan-500 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white font-bold text-xl md:text-2xl px-8 py-6 rounded-2xl transition-all duration-300 shadow-xl shadow-purple-500/30 hover:shadow-pink-500/40 transform hover:scale-[1.03] active:scale-[0.97] btn-3d"
            >
              {loading ? (
        ...
        <div className="mt-16 glass-strong rounded-3xl p-8 md:p-10 border-2 border-purple-500/30 shadow-2xl animate-slide-up">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 flex items-center justify-center md:justify-start">
            <span className="text-5xl mr-4 animate-float">💡</span>
            <span className="gradient-text">Example Descriptions</span>
          </h3>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 animate-fade-in">
          <div className="text-center p-8 glass rounded-2xl border-2 border-cyan-500/30 hover:border-cyan-500/60 transition-all duration-300 card-3d hover-glow group">
            ...
            <h4 className="text-white font-bold text-xl mb-3 gradient-text-blue">Multi-Language Support</h4>
            <p className="text-gray-300 text-base font-medium">Create problems in English, Hindi, or Hinglish with ease</p>
          </div>
          <div className="text-center p-8 glass rounded-2xl border-2 border-pink-500/30 hover:border-pink-500/60 transition-all duration-300 card-3d hover-glow group" style={{ animationDelay: '0.1s' }}>
            ...
            <h4 className="text-white font-bold text-xl mb-3 gradient-text-pink">Instant Generation</h4>
            <p className="text-gray-300 text-base font-medium">Get your coding problems generated in seconds</p>
          </div>
          <div className="text-center p-8 glass rounded-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 card-3d hover-glow group" style={{ animationDelay: '0.2s' }}>
            ...
            <h4 className="text-white font-bold text-xl mb-3 gradient-text-purple">Intelligent AI</h4>
            <p className="text-gray-300 text-base font-medium">Smart context detection and pattern recognition</p>
          </div>
        </div>
      </div>
    </div>
